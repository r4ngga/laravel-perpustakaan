...
class BooksController extends Controller
{
    ...
    public function fetchIndex(){
        ...
        foreach($books as $book){
            ...
            $html .= '<td>'; //act
                $html .= '<a onclick="getEdtBook( '.$book->id_book.','.$book->name_book .', '. $book->isbn .','.$book->author.','.$book->publisher.', '.$book->time_release.','.$book->pages_book.','.$book->language.')" data-toggle="modal" data-target="#editbook" class="btn btn-info"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">';
                ...
                $html .= '<a href="'.$book->id_book.'/#ComfirmDeleteModal" class="btn btn-danger" data-toggle="modal" data-target="#ComfirmDeleteModal'.$book->id_book.'"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">';
                ...
                $html .= '<a href="#" class="btn btn-warning">Show a Detail</a>';
            $html .= '</td>';
            $html .= '</tr>';
        }
