...
class BorrowsController extends Controller
{
    ...
    public function index()
    {
        ...
        $countBorrow = DB::table('book_borrows')->count();

        return view('admin.report.report_borrow', compact('borrow', 'countBorrow'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('notify', 'Successfully borrow a book');
    }
}
